...
define([
    ...
    describe("SettingsDialog", function () {
        ...
        it('should be able to add views on init', function () {
            ...
            expect(countChildrenByClass(dialog.view.getElement(), 'eaVisualizationEngineApp-wVEViewSelect')).to.equal(2);
        });
        ...
        it('should be able to add views to a running dialog', function () {
            ...
            expect(countChildrenByClass(dialog.view.getElement(), 'eaVisualizationEngineApp-wVEViewSelect')).to.equal(3);
        });
    });
});