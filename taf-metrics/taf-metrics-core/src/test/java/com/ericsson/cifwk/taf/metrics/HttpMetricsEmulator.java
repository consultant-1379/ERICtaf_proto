...
import com.ericsson.cifwk.taf.metrics.sample.SampleBuilder;
...
public final class HttpMetricsEmulator {
    ...
    public HttpMetricsEmulator(Dumpling dumpling, String executionId) {
        this.dumpling = dumpling;
        this.executionId = executionId;
    }

    public static void emulate(Dumpling dumpling, final int count) throws IOException {
